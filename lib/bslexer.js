...
var bslexer = (function() {    
    var TokenType = { Integer: 1, Real: 2, String: 3, Name: 4, Operator: 5, Delimiter: 6, EndOfLine: 7 };
    ...
    function Lexer(text) {
        ...
        this.nextToken = function() {
            ...
            if (isDelimiter(ch))
                return nextDelimiter(ch);
                
            if (isOperator(ch)) {
                var ch2 = nextChar();
                
                if (isOperator(ch+ch2))
                    return nextOperator(ch+ch2);
